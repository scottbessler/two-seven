...
impl SharkParams {
    pub const DEFAULT: Self = Self {
        ...
        big_blind_defense_score: 2,
        small_blind_defense_score: 3,
        other_defense_score: 5,
        ...
        short_stack_bb: 20,
        heads_up_in_position_edge: 0.08,
        heads_up_out_of_position_edge: 0.13,
        multiway_in_position_edge: 0.11,
        multiway_out_of_position_edge: 0.17,
