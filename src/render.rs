...
pub fn blackjack_table() -> String {
    layout_with_header(
        "Blackjack",
        r#"<section class="blackjack-shell"><div id="blackjack-app"><section class="blackjack-table"><div class="actions blackjack-actions"><span class="deal-broke">Loading your table…</span></div></section></div></section>"#,
        &format!(
            r#"<script type="module" src="{}" defer></script>"#,
